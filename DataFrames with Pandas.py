...
count_by_weekday1 = users.pivot_table(aggfunc='count', index='weekday')

# Print count_by_weekday
print(count_by_weekday1)

# Replace 'aggfunc='count'' with 'aggfunc=len': count_by_weekday2
count_by_weekday2 = users.pivot_table(aggfunc=len, index='weekday')
...
signups_and_visitors = users.pivot_table(aggfunc=sum,index='weekday')

# Print signups_and_visitors
print(signups_and_visitors)

# Add in the margins: signups_and_visitors_total
signups_and_visitors_total = users.pivot_table(aggfunc=sum,index='weekday', margins=True)
...
survived_mean_2 = titanic['survived'].groupby([under10,titanic['pclass']]).mean()
